// src/pages/FeatureYPage.jsx
import React, { useState } from "react";
import { callFeatureY } from "@/api/client"; // use '../api/client' if no alias

export default function FeatureYPage() {
  ...
  async function submit(e){
    ...
    try {
      setLoading(true);
      const data = await callFeatureY(body);
      setRes(data);
    } catch (e) {
  ...
  return (
    <div className="page-wrap">
      <h1>Services · Feature Y</h1>
      <p className="subtitle">Frontend for the Feature Y endpoint.</p>
